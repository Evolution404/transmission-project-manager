...
最近一次完整 `npm run check`：Node **307/307 PASS**、Web **155/155 PASS（23 个测试文件）**；TypeScript、Web production build、Worker `wrangler deploy --dry-run`、Node + SQLite + Filesystem 第二运行时均 PASS。
