...
.editor-intro strong { font-size: 13px; }.editor-intro span { color: var(--ui-text-secondary); font-size: 13px; line-height: 1.6; }
...
.editor-heading { display: flex; justify-content: space-between; margin-bottom: 10px; }.editor-heading h4 { margin: 0; font-size: 13px; }.editor-heading p { margin: 3px 0 0; color: var(--ui-text-tertiary); font-size: 13px; }
...
.selected-list span,.candidate-list label > span:last-child { display: grid; gap: 2px; min-width: 0; flex: 1; }.selected-list strong,.candidate-list strong { font-size: 13px; }.selected-list small,.candidate-list small { overflow: hidden; color: var(--ui-text-secondary); font-size: 13px; text-overflow: ellipsis; white-space: nowrap; }
...
@media(max-width:767px){ :global(.project-source-drawer.n-drawer){left:0!important;right:auto!important;top:0!important;bottom:auto!important;width:100dvw!important;max-width:100dvw!important;height:100dvh!important;max-height:100dvh!important;min-height:0;overflow:hidden}.editor-actions .n-button:last-child{flex:1}.candidate-list{max-height:none} }
</style>
