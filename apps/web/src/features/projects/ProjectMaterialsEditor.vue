...
<style scoped>
.editor-intro{display:grid;gap:5px;margin-bottom:16px;padding:13px 14px;border:1px solid var(--ui-border);border-radius:11px;background:var(--ui-surface-subtle)}.editor-intro strong{font-size:13px}.editor-intro span{color:var(--ui-text-secondary);font-size:12px;line-height:1.6}.editor-alert{margin-bottom:14px}.material-editor-list{display:grid;border-top:1px solid var(--ui-border)}.material-editor-row{padding:15px 0;border-bottom:1px solid var(--ui-border)}.material-row-head{display:flex;align-items:center;justify-content:space-between;margin-bottom:10px}.material-row-head strong{font-size:12px}.material-fields{display:grid;grid-template-columns:minmax(150px,1.3fr) minmax(100px,.7fr) minmax(85px,.55fr) minmax(150px,1fr) minmax(150px,1fr);gap:9px}.material-fields label,.reason-field{display:grid;gap:5px}.material-fields label>span,.reason-field>span{color:var(--ui-text-secondary);font-size:12px;font-weight:600}.add-material{margin-top:14px}.reason-field{margin-top:18px;padding-top:16px;border-top:1px solid var(--ui-border)}.editor-actions{position:sticky;bottom:0;display:flex;justify-content:flex-end;gap:9px;padding:14px 0 max(4px,env(safe-area-inset-bottom));background:var(--ui-surface)}
@media(max-width:900px){.material-fields{grid-template-columns:1fr 1fr}.material-fields label:first-child{grid-column:1/-1}}@media(max-width:767px){:global(.project-materials-drawer.n-drawer){left:0!important;right:auto!important;top:0!important;bottom:auto!important;width:100dvw!important;max-width:100dvw!important;height:100dvh!important;max-height:100dvh!important;min-height:0;overflow:hidden}.material-fields{grid-template-columns:1fr}.material-fields label:first-child{grid-column:auto}.editor-actions .n-button:last-child{flex:1}}
</style>
