...
import { projectDeliveryApp } from './project-delivery.ts';
import { projectTaskProgressApp } from './project-task-progress.ts';
import { projectLifecycleApp } from './project-lifecycle.ts';
import { publicAuthenticationApp } from './public-authentication.ts';
import { reserveCategoryConfigApp } from './reserve-category-config.ts';
...
app.route('/api', projectExecutionQueryApp);
app.route('/api', projectDeliveryApp);
app.route('/api', projectTaskProgressApp);
app.route('/api', demandImportApp);
app.route('/api', reserveCategoryConfigApp);
